...
void initPhil(){
    ...
    for(int j = 0; j<5; j++){
        ...
        switch(j){
            case 0:
                //pids[0] =
                start_proc_user("Aristoteles", (void*) philosophers, 1, cero);
                break;
            case 1:
                //pids[1] =
                start_proc_user("Socrates", (void*) philosophers, 1, uno );
                break;
            case 2:
                //pids[2] =
                start_proc_user("Platon", (void*) philosophers, 1, dos);
                break;
            case 3:
                //pids[3] =
                start_proc_user("Simone de Beauvoir", (void*) philosophers, 1, tres);
                break;
            case 4:
                //pids[4] =
                start_proc_user("Kant", (void*) philosophers, 1, cuatro);
                break;
            // // default:
